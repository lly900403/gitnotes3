...
% if need to adjust to the screen's size
%set(gcf, 'Position', get(0,'Screensize'));

% Scattered chart TargetFund vs FactorPortfolio, and 'Zero-Alpha Line'
% #################
...
%range adjust
if numberoffund==1
    plot232xlim1=-max([abs(VolAdjAlphaDist{1}),abs(VolAdjAlphaDist{2})])*12;
    plot232xlim2=max([abs(VolAdjAlphaDist{1}),abs(VolAdjAlphaDist{2})])*12;
end
