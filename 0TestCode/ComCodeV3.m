...
FactorExposure = zeros(numberoffund,length(UserFilteredFactorID));
PValFactor = zeros(numberoffund,length(UserFilteredFactorID));
SignificantFactor = zeros(numberoffund,length(UserFilteredFactorID));
